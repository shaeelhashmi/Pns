...
export default function Page404() {
  return (
    <div className="bg-gradient-to-r from-[#047957] via-green-400 to-[#047957] bg-[#047957] p-1 rounded-xl shadow-lg my-20">
    <div className="bg-white rounded-xl px-12 py-10 flex flex-col items-center ">
      ...
      <a href="/" className="inline-block mt-2 px-6 py-3 rounded-lg font-medium text-white  bg-[#38A169] hover:bg-[#4c8969] transition-all duration-500">
        Go Home
      </a>
    </div>
  </div>
