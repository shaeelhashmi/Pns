export default function Heading(props: { 
  ...
  return (
    <h1
      className={"md:text-4xl sm:text-3xl text-2xl w-fit font-bold after:w-[70%] after:content-[''] after:block after:h-[2px] after:mt-2 block font-georgia" + (props.class ? ' ' + props.class : '')}
      style={{
        color: textColor,
